...
namespace BPCalculator
{
    ...
    public class BloodPressure
    {
        ...
        {
            return (this.Systolic < 90) && (this.Diastolic < 60 && this.Diastolic >= 40 || this.Diastolic < 60);
        }
        ...
        {
            return ((this.Systolic < 120 && this.Systolic >= 90 || this.Systolic < 120) && (this.Diastolic < 80 && this.Diastolic >= 60 || this.Diastolic < 80));
        }
        ...
        {
            return ((this.Systolic < 140 && this.Systolic >= 120 || this.Systolic < 140) && (this.Diastolic < 90 && this.Diastolic >= 80 || this.Diastolic < 90));
        }
        ...
        {
            return ((this.Systolic < 190 && this.Systolic >= 140 || this.Systolic < 190) && (this.Diastolic < 100 && this.Diastolic >= 90 || this.Diastolic < 100));
        }
